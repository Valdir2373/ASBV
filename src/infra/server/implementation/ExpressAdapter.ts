...
import { IMiddlewareHandler } from "../../middleware/interfaces/IMiddlewareHandler.js";
import { IRequest } from "../../middleware/interfaces/IRequest.js";
import { IResponse } from "../../middleware/interfaces/IResponse.js";
import { IServerHttp, HttpMethods } from "../interfaces/IServerHttp.js";
import { IFile } from "../../middleware/interfaces/IFile.js";
import { ICookieOptions } from "../../middleware/interfaces/ICookieOptions.js";
...
export class ExpressAdapter implements IServerHttp {
  private app: Express;
  ...
  constructor() {
    ...
    this.app.use("/js", express.static(path.join(import.meta.dirname, "js")));
    this.app.use("/css", express.static(path.join(import.meta.dirname, "css")));
